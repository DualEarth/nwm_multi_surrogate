...
# Fixed CRS for NWM Hawaii files. This will be used as a fallback if CRS inference from file attributes fails. These parameters are common for the NWM Hawaii domain's Lambert Conformal Conic projection.
